...
/-!
# Varying physical targets in an active coordinate presentation
-/
...
/-- The varying-run physical-target wrapper for an arbitrary proper
nondegenerate bounding presentation. -/
theorem exists_centeredScaledActivePhysicalTargetCertificateConstants
  ...
  obtain ⟨corConstant, corWidth, denseConstant, denseEll, denseWidth,
    ...
    exists_centeredScaledActivePhysicalReserveCertificateConstants
  ...
  intro W B A P hPproper hPnondegenerate hBW hAB hzeroW hzeroB q cap
    target sourceScale s D K block c run hell hwidthScale hCell hsourceScale
    hblock hdD
  ...
  exact hcertificate P hPproper hPnondegenerate hBW hzeroW hzeroB
    ...
    hreserveDisjoint hreserveSmall hsUpper hscaleUpper hnoCarry
