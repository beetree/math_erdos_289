...
- `kept_modules.txt` / `dropped_modules.txt`: the 236 used / 22 unused modules. The unused
...
- `closure_decl_ranges.txt`: for every declaration in every module, `KEEP`/`DROP` (used /
