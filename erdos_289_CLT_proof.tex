...
The second author's earlier solution \cite{Land} gives a stronger conclusion
at the price of a longer argument: intervals of length two and three only,
all inside $[1,20k]$.
\end{remark}
...
Theorem~\ref{main} has been verified in Lean~4 with Mathlib, following the
proof above lemma by lemma. The terminal declaration
\texttt{Erdos289.CLT.main\_theorem}, in the directory \texttt{Erdos289CLT} of
the repository \cite{Repo}, proves a proposition stating Theorem~\ref{main}
verbatim; its axiom report lists only \texttt{propext},
\texttt{Classical.choice} and \texttt{Quot.sound}, and no result from the
literature is assumed. The same repository contains the earlier formalization
\cite{Land} of the stronger statement with intervals of length two or three
inside $[1,20k]$.
...
The proof in Sections~2--4 is a simplification, obtained with the help of GPT~6, of the
arguments in \cite{Land,Tang}. The Lean formalization was written with Claude
and GLM models from a human-written skeleton of definitions and lemma
statements.
...
manuscript, 4 September 2026,
\url{https://github.com/beetree/math_erdos_289/blob/main/erdos_289_full_proof.pdf}.
\bibitem{Repo} S.~Cambie, J.~Land and Y.~Tang,
\emph{Erd\H{o}s Problem 289: Lean formalizations},
Zenodo, 2026, \url{https://doi.org/10.5281/zenodo.22731916}
(\url{https://github.com/beetree/math_erdos_289}, release \texttt{v2.0-clt-certificate}).
\bibitem{Tang} Y.~Tang,
