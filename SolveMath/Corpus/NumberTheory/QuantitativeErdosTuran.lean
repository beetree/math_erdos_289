...
A quantitative Erdős--Turán inequality for an anchored half-open interval,
with multiplicities retained: the points are indexed by an arbitrary finite
set rather than stored in a `Finset` of points.
...
namespace QuantitativeErdosTuran
